...
public class ProductPage {
    ...
    public void visitProduct(long productId, Customer customer) {
        ...
        switch (answer) {
            case 1 ->addComment(productId,customer);
            case 2 ->addScore(productId,customer);
    ...
    void addComment(long productId,Customer customer){
        ...
        scoreController.commentRequest(productId,comment,customer);
    }
    void addScore(long productId,Customer customer){
        System.out.println("-------------------------------------------------------------------------");
        System.out.println("Please enter your score.");
        float score=scanner.nextFloat();
        if(scoreController.scoreProduct(productId,score,customer)){
